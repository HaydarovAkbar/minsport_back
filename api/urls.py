...
vote_router.register(r'participants', rating.ParticipantsViewSet, basename='participants-api')
vote_router.register(r'evolution_criteria', rating.EvolutionCriteriaViewSet, basename='evolution_criteria-api')
vote_router.register(r'participants_vote', rating.VoteViewSet, basename='participants_vote-api')
vote_router.register(r'participants_filter', rating.ParticipantsFilterViewSet, basename='participants_filter-api')
vote_router.register(r'bot_link', rating.BotLinkViewSet, basename='bot_link-api')

vote_router.register(r'department', about.DepartmentView, basename='department-api')
vote_router.register(r'organizations', about.OrganizationView, basename='organization-api')
vote_router.register(r'regions', site.RegionView, basename='region-api')
vote_router.register(r'districts', site.DistrictView, basename='district-api')
# vote_router.register(r'menu-dev', site.MenuDevView, basename='menu-dev-api')
# vote_router.register(r'header', site.HeaderDevView, basename='header-api')
...
adm_router.register(r'structure', about.AdmMinistryStructureView, basename='structure-api')
adm_router.register(r'staff', about.AdmMinistryStaffView, basename='staff-api')
adm_router.register(r'stat', about.AdmMinistryStatView, basename='stat-api')
adm_router.register(r'department', about.AdmMinistryDepartmentView, basename='department-api')
adm_router.register(r'organization', about.AdmMinistryOrganizationView, basename='organization-api')
adm_router.register(r'index', index.IndexView, basename='index-api')
adm_router.register(r'vacancy', vacancy.AdmVacancyView, basename='vacancy-api')
adm_router.register(r'education', vacancy.AdmEducationView, basename='education-api')
adm_router.register(r'employment', vacancy.AdmEmploymentView, basename='employment-api')
adm_router.register(r'service', service.AdmServiceView, basename='service-api')
adm_router.register(r'doc_type', docs.AdmDocTypeView, basename='doc_type-api')
adm_router.register(r'docs', docs.AdmDocsView, basename='docs-api')
adm_router.register(r'stadion', sport.AdmStadionView, basename='station-api')
adm_router.register(r'sport_type', sport.AdmSportTypeView, basename='sport_type-api')
adm_router.register(r'champion', sport.AdmChampionView, basename='champion-api')
adm_router.register(r'news', news.AdmNewsView, basename='news-api')
adm_router.register(r'news_media', news.AdmNewsSMediaView, basename='news_media-api')
adm_router.register(r'news_image', news.AdmMediaImageView, basename='news_image-api')
adm_router.register(r'news_hashtag', news.AdmNewsHashtagView, basename='news_hashtag-api')
adm_router.register(r'news_category', news.AdmNewsCategoryView, basename='news_category-api')
adm_router.register(r'photo_gallery', news.AdmPhotoGalleryView, basename='photo_gallery-api')
adm_router.register(r'photo_gallery_image', news.AdmPhotoGalleryImageView, basename='photo_gallery_image-api')
adm_router.register(r'video_gallery', news.AdmVideoGalleryView, basename='video_gallery-api')
adm_router.register(r'press', news.AdmPressView, basename='press-api')
adm_router.register(r'press_article', news.AdmPressArticleLinkView, basename='press_article-api')
adm_router.register(r'faq', news.AdmFAQView, basename='faq-api')
adm_router.register(r'external_image', gallery.AdmExternalImageView, basename='external_image-api')
adm_router.register(r'event', event.AdmEventView, basename='event-api')
adm_router.register(r'tender', tender.AdmTenderView, basename='tender-api')
adm_router.register(r'tender-type', tender.AdmTenderTypeView, basename='tender-type-api')
adm_router.register(r'tender-notices', tender.AdmTenderNoticesView, basename='tender-notices-api')
adm_router.register(r'tender-photos', tender.AdmTenderNoticesPhotosView, basename='tender-notices-photos-api')

adm_router.register(r'regions', site.RegionView, basename='adm-region-api')
adm_router.register(r'districts', site.DistrictView, basename='adm-district-api')
adm_router.register(r'quizz', quizz.AdmQuizzView, basename='quizz-api')
adm_router.register(r'question', quizz.AdmQuestionView, basename='question-api')
adm_router.register(r'link', site.AdmUsefulLinkView, basename='link-api')
adm_router.register(r'quizz-result', quizz.AdmQuestionResultView, basename='quizz-result-api')
adm_router.register(r'main-page', site.AdmMainPageSettingView, basename='main-page-api')
adm_router.register(r'contact', site.AdmContactSettingView, basename='contact-api')
...
urlpatterns = [
    ...
    path('adm/', include(adm_router.urls)),
]
