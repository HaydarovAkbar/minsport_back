...
class StaticDataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'url', 'slug', 'views', 'active', 'content', 'image', 'file', 'icon', 'main_url',
        ]
    ...
    def to_representation(self, instance):
        try:
            ...
            data['title'] = getattr(instance, f'title_{language}')
            data['content'] = getattr(instance, f'content_{language}')
            return data
        except Exception:
